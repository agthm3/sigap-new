...
<div class="flex gap-2 mt-2">
          ...
          <button type="button" id="btn-share-wa" 
                  class="flex-1 px-3 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-semibold flex items-center justify-center gap-2 shadow-sm transition-all">
          ...
          {{-- Tombol Live Absensi --}}
          <a href="{{ route('sigap-daftar-hadir.live', $kegiatan->uuid) }}" target="_blank"
             class="flex-1 px-3 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold flex items-center justify-center gap-2 shadow-sm transition-all">
