...
<div class="pt-3 mt-3 border-t border-gray-200 text-xs text-gray-500 px-3">
        ...
        <div id="kinerjaMenu" class="ml-3 mt-1 space-y-1 hidden">
          ...
          <a href="{{ route('sigap-feed.create') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('sigap-feed.create') ? 'bg-maroon text-white' : 'hover:bg-gray-100' }}">
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-width="2" d="M4 6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6z"/><path stroke-width="2" d="M4 12h16M12 4v16"/></svg>
            SIGAP Feed
          </a>
